...
export default function SettingsPage() {
  return (
    <div>
      <PageHeader title="Settings" description="Lab profile and system preferences" />
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <section className="lims-card p-4 lg:col-span-2">
          ...
          <p className="mt-2 text-sm text-muted">Configure email, SMS, and WhatsApp templates for registration, invoice, and report-ready triggers.</p>
