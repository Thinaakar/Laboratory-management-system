...
export default function LoginPage() {
  return (
    <div className="flex min-h-screen flex-col bg-muted-bg lg:flex-row">
      <div className="order-1 flex w-full items-center justify-center bg-slate-50/70 px-4 py-10 sm:px-8 lg:order-2 lg:w-[40%] lg:shrink-0 lg:px-10 lg:py-12 border-l border-slate-100/50">
        <LoginFormCard />
      </div>
