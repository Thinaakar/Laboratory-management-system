...
export function PatientRegistrationModal({
  ...
  useEffect(() => {
    ...
    if (patient) {
      ...
      setReferredDoctor(patient.referredDoctor ?? "");
      setPatientType(patient.patientType ?? "Walk-In");
    } else {
          ...
          <div className="lims-surface flex w-full max-w-2xl max-h-[calc(100vh-2rem)] flex-col overflow-hidden sm:max-h-[min(92vh,calc(100vh-3rem))]">
              ...
              <div>
                ...
                <p className="mt-0.5 text-sm text-muted">
                  {isEdit
                    ...
                    : "Add a new patient to the laboratory registry"}
                </p>
              </div>
              <button
                type="button"
            ...
            >
              <div className="lims-dialog-body">
                ...
                <FormField
                  label="Patient ID"
                  hint="Assigned automatically when you save."
                >
                  <input
